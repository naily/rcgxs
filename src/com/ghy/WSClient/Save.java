...
@XmlType(name = "save", propOrder = { "items" })
public class Save {

	@XmlElement(name = "Items")
	protected Save.Items items;

	/**
	 * Gets the value of the items property.
	 * 
	 * @return possible object is {@link Save.Items }
	 * 
	 */
	public Save.Items getItems() {
		return items;
	}
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link Save.Items }
	 * 
	 */
	public void setItems(Save.Items value) {
		this.items = value;
	}
