...
@XmlType(name = "remove", propOrder = { "items" })
public class Remove {

	@XmlElement(name = "Items")
	protected Remove.Items items;

	/**
	 * Gets the value of the items property.
	 * 
	 * @return possible object is {@link Remove.Items }
	 * 
	 */
	public Remove.Items getItems() {
		return items;
	}
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link Remove.Items }
	 * 
	 */
	public void setItems(Remove.Items value) {
		this.items = value;
	}
