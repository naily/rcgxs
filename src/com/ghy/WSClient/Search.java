...
@XmlType(name = "search", propOrder = { "items" })
public class Search {

	@XmlElement(name = "Items")
	protected Search.Items items;

	/**
	 * Gets the value of the items property.
	 * 
	 * @return possible object is {@link Search.Items }
	 * 
	 */
	public Search.Items getItems() {
		return items;
	}
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link Search.Items }
	 * 
	 */
	public void setItems(Search.Items value) {
		this.items = value;
	}
