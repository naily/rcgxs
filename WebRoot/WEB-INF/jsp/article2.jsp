...
<title>${requestScope.obj.bean.title}</title>
...
<div class="box7_1">
<div class="newstitle"><strong>${requestScope.obj.bean.title}</strong></div>
<div class="newscaption">${requestScope.obj.bean.startDate} &nbsp; &nbsp;发布者：  &nbsp; &nbsp; </div>
<div class="newstext">    ${requestScope.obj.bean.text}</div>
