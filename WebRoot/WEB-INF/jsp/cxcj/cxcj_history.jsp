...
<body style="padding:6px; width:650px; border:#006 solid 0px; overflow:hidden;">
  ...
  <table  border="0" cellpadding="0" cellspacing="0" class="box10">
   ...
   <tr>
     <td height="30" align="center" valign="middle" class="style4" > 本次对接会我乡共成交农产品 ${requestScope.obj.jiaoyiall} 千克，成交额 ${requestScope.obj.jiaoyiallmoney} 元 </td>
   </tr>
   <tr>
     <td class="style3"><table width="650" border="0" cellpadding="1" cellspacing="1" bgcolor="#d5d5d5">
       <tr>
         <td width="19%" height="30" align="center" valign="middle" bgcolor="#fbf2eb" class="tabletitle2">主要品种</td>
         <td width="22%" height="30" align="center" valign="middle" bgcolor="#fbf2eb" class="tabletitle2">成交量（千克）</td>
         <td width="20%" height="30" align="center" valign="middle" bgcolor="#fbf2eb" class="tabletitle2">成交量比例</td>
         <td width="20%" height="30" align="center" valign="middle" bgcolor="#fbf2eb" class="tabletitle2">成交额（元）</td>
		   <td width="19%" height="30" align="center" valign="middle" bgcolor="#fbf2eb" class="tabletitle2">成交额比例 </td>
        </tr>
        <c:forEach items="${requestScope.obj.list5}" var="bj" varStatus="status" >
        <tr>
         <td height="26" align="center" valign="middle" bgcolor="#FFFFFF">${bj.chanpin}</td>
         <td height="26" align="center" valign="middle" bgcolor="#FFFFFF">${bj.jiaoyiall}</td>
         <td height="26" align="center" valign="middle" bgcolor="#FFFFFF">${bj.chanpinuti}</td>
         <td height="26" align="center" valign="middle" bgcolor="#FFFFFF">${bj.jiaoyiallmoney}</td>
         <td height="26" align="center" valign="middle" bgcolor="#FFFFFF">${bj.chanpinmonuti}</td>
        </tr>
        </c:forEach>
     </table></td>
   </tr>
   <tr>
     <td height="10" class="style3"></td>
   </tr>
   <tr>
     <td>
      <table width="650" border="0" cellpadding="1" cellspacing="1" bgcolor="#d5d5d5">
       <tr>
         ...
         <td width="15%" height="35" align="center" valign="middle" bgcolor="#fbf2eb" class="tabletitle2">计划交易量<br />（千克）</td>
