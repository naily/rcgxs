...
<a href="${requestScope.obj.link1}" class="a9">${requestScope.obj.bar1}</a>&nbsp;&gt;&nbsp;
<a href="#" class="a9">${requestScope.obj.bar2}</a>&nbsp;&gt;&nbsp;正文</div>
<div class="box7_1">
<div class="newstitle"><strong>${requestScope.obj.title}</strong></div>
<div class="newscaption">日期：${requestScope.obj.startDate} &nbsp; &nbsp;<!-- 发布者：  &nbsp; &nbsp;  --></div>
